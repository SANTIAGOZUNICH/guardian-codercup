...
- **Deploy actual**: verificado directamente contra la API de Vercel (no asumido) — proyecto `guardian-codercup`, deployment `dpl_DhzNZdBcVKV2bgWYVfg182ejBUK5`, commit `2516b975fffe8620bb480fd537e2d205ec15d2b7`, status `READY`, `target: production`, servido en `https://guardian-codercup.vercel.app`.
