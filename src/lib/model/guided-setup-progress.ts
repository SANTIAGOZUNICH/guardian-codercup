...
/** products, presentations, equipment, capacities, batchTimes, staffing, schedule, materials — excluye "review" (no es una pregunta, es el resumen final). Debe coincidir con `STEPS_V2.length - 1` en `GuidedSetupScreen.tsx`. */
